...
(function() {
  ...
  window.pinsAction = {
    ...
    initPins: function(initOffers) {
      ...
      for (var i = 0; i < initOffers.length; i++) {
        ...
        newElement.style =
          "left: " +
          (initOffers[i].location.x + MARGIN_X) +
          "px; top: " +
          (initOffers[i].location.y + MARGIN_Y) +
          "px;";
        newElement.className = "map__pin hidden";
        newElement.innerHTML =
          '<img src="' +
          initOffers[i].author.avatar +
  ...
  window.load(URL, "GET", onUploadSuccess, window.pinsAction.onLoadError);
  ...
  function onPinClick(evt) {
    ...
    for (var i = 0; i < offers.length; i++) {
      if (
        objImageSrc.indexOf(offers[i].author.avatar) !== -1 &&
        objTarget.offsetTop - MARGIN_Y === offers[i].location.y &&
        objTarget.offsetLeft - MARGIN_X === offers[i].location.x
      ) {
